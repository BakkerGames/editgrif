...
internal static class CurrentValues
{
    ...
    public static string? roomsShortDescPattern;
    public static string? roomsLongDescPattern;
    public static string? roomsExitsPattern;
    ...
    public static string? itemsShortDescPattern;
    public static string? itemsLongDescPattern;
    public static string? itemsLocationPattern;
